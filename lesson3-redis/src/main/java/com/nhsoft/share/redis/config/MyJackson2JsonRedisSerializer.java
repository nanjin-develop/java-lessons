...
public class MyJackson2JsonRedisSerializer implements RedisSerializer<Object> {
	...
	public MyJackson2JsonRedisSerializer(String classPropertyTypeName) {
		...
		if (!StringUtils.isEmpty(classPropertyTypeName)) {
	 ...
	 * 
	 * @see
	 * org.springframework.dto.redis.serializer.RedisSerializer#serialize(java
	 * .lang.Object)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.dto.redis.serializer.RedisSerializer#deserialize
	 * (byte[])
	 */
	@Override
